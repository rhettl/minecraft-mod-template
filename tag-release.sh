...
# Example: ./tag-release.sh 0.4.0 -m "Release v0.4.0 with new feature"
...
REPO_URL=$(git remote get-url "$REMOTE" 2>/dev/null | sed 's/\.git$//' | sed 's|git@github.com:|https://github.com/|')
...
# Update gradle.properties (uses modVersion for Kotlin DSL compatibility)
